...
<div class="left_bar col-md-9">
    <div class="d-flex align-items-center justify-content-between">
        <h2>EVENT TITLE</h2>
        <a href="#" class="btn btn-secondary">To joint this event</a>
    </div>
    <hr>
    <div class="row eventBlogdetail ml-0 mr-0 pt-3 pb-3 mb-4">
        ...
        <div class="col-md-8">
            <h3>Title 1</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti esse quaerat cumque omnis labore! Consequatur nesciunt, voluptatum asperiores provident quas, voluptate, aperiam eius minus a enim vel quis omnis corrupti? Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates quas quod mollitia numquam aperiam. Deleniti explicabo maxime ut eius at quo, eaque non? Iste nam rem debitis, ab cumque eum.</p>
